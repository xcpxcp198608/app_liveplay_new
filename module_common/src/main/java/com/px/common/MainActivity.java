...
import com.px.common.databinding.ActivityMainCommonBinding;
...
//    private static final String URL = "http://www.ldlegacy.com:8080/control_panel/update/get";
    ...
    private ActivityMainCommonBinding binding;
    private Disposable disposable;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_main_common);
