...
//        Log.d("----px----" , apkVersionName);
    ...
    public static String getApkPackageName (String filePath ,String fileName){
        ...
        PackageInfo packageInfo = packageManager.getPackageArchiveInfo(filePath+fileName ,PackageManager.GET_ACTIVITIES);
        if(packageInfo != null){
    ...
    public static boolean isApkCanInstall (String filePath, String fileName){
        ...
        PackageInfo packageInfo = packageManager.getPackageArchiveInfo(
                filePath + "/" + fileName, PackageManager.GET_ACTIVITIES);
